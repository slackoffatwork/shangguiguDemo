  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addressInfo" :key="address.id"
        @click="addressChange(address, addressInfo)">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ getAddress.fullAddress }}</span>
        收货人：<span>{{ getAddress.consignee }}</span>
        <span>{{ getAddress.phoneNum }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <!-- <router-link class="subBtn" @click="submitOder" to="/pay">提交订单</router-link> -->
      <a class="subBtn" @click="submitOder">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async submitOder() {
      ...
      let data = {
        "consignee": this.getAddress.consignee,
        "consigneeTel": this.getAddress.phoneNum,
        "deliveryAddress": this.getAddress.fullAddress,
        "paymentWay": "ONLINE",
